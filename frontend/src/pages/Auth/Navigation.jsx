            ...
            >
              ...
              {userInfo ? (
                <span className="flex gap-2 text-base font-medium capitalize text-[#d8e2f2c3] hover:text-[#FFF]">
                  <p><span className="text-red-500">Hello</span>,</p>
                     <p className=" overflow-hidden text-ellipsis whitespace-nowrap">{userInfo.username}</p>
                    </span>
                  ) : (
                    <></>
                    )}
              ...
              {dropdownOpen && userInfo && (
                <ul
                  className={`absolute bg-[#000] text-[#fffff] rounded-sm top-[50px] right-0 border border-[#858585] w-400 lg:w-52 z-20`}
                  onClick={() => setDropdownOpen(false)}
                >
